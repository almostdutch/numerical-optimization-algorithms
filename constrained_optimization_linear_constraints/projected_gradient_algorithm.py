"""
projected_gradient_algorithm.py
...
def projected_gradient_algorithm_var_alpha(X0, func, func_grad, func_hessian, P, options):
...
def projected_gradient_algorithm_linesearch(X0, func, func_grad, P, options):
