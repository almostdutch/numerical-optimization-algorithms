...
def projected_quasi_newton_algorithm(X0, func, func_grad, func_hessian, P, options):
...
def projected_quasi_newton_algorithm_linesearch(X0, func, func_grad, P, options):
